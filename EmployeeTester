# SimpleDatabase
This java program allows user to keep a simple database record
// An EmployeeTester class that allows to test the method and constructor of class Employee
